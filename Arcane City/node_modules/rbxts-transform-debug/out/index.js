    ...
    switch (functionName) {
        ...
        case MacroFunctionName.nameof: {
            if (typescript_1.default.isExpressionStatement(node.parent)) {
                console.log((0, shared_1.formatTransformerWarning)("Call to ".concat(node.getText(), ", which is not used anywhere. It has been stripped."), node));
        ...
        case MacroFunctionName.time:
            return (0, time_1.transformTime)(node);
        default:
            throw (0, shared_1.formatTransformerDiagnostic)("function ".concat(chalk_1.default.yellow(functionName), " cannot be handled by this version of rbxts-transform-debug"));
    }
}
...
function visitNode(node, program, config) {
    if (isModuleImportExpression(node, program)) {
        ...
        if (importClause !== undefined) {
            return typescript_1.factory.updateImportDeclaration(node, undefined, undefined, typescript_1.factory.updateImportClause(importClause, true, importClause.name, importClause.namedBindings), node.moduleSpecifier, undefined);
        }
...
function transform(program, userConfiguration) {
    ...
    if (userConfiguration.verbose) {
        ...
        console.log((0, shared_1.formatTransformerDebug)("Macros enabled: ".concat(chalk_1.default.cyan(userConfiguration.enabled))));
    }
